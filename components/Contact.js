...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .send(
        "service_1yk6lx4", // replace with your EmailJS service ID
        "template_k6ypmc6", // replace with your EmailJS template ID
        formData,
        "O-LqCKzkBX3143W8L" // replace with your EmailJS user ID
      )
      .then(
        (result) => {
      ...
      <div className="relative z-10 rounded-md shadow-md bg-[#02044A] p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <form className="form rounded-lg bg-white p-4 flex flex-col" onSubmit={sendEmail}>
            ...
            <button
              type="submit"
              className="bg-[#02044A] rounded-md w-1/2 mx-4 mt-8 py-2 text-gray-50 text-xs font-bold"
            >
              Send Message
            </button>
          </form>
